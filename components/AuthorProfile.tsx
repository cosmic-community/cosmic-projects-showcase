...
export default function AuthorProfile({ author }: AuthorProfileProps) {
  return (
    <div className="bg-gradient-to-br from-gray-50 to-white rounded-xl p-8 border border-gray-200 mb-12">
      <div className="flex flex-col md:flex-row items-start md:items-center space-y-6 md:space-y-0 md:space-x-8">
        ...
        <div className="flex-1">
          ...
          {author.metadata.bio && (
            <p className="text-gray-700 text-lg mb-6">{author.metadata.bio}</p>
          )}
